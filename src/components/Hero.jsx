...
const Hero = (props) =>{
    ...
    <h4>My Skills:</h4>
    <p>JavaScript, React.JS, Node.JS, Tailwind CSS, Bootstrap, SCSS, C++, Java, Competitive Programming, Creative Problem Solving, WordPress, Digital Marketing, SEO, Google Ads Manager, Microsoft Office, Git, Shopify, Jira, Meta Business Suite, Multimedia Design, User Experience (UX).</p>

    <div className="spacer"></div>
    <h4>Experience:</h4>
    <p><b>Director of Business Development</b> | Pronto Live Marketing, Yuba City, CA (Hybrid)</p>
    <p>Leading business growth through strategic partnerships and market expansion, fostering long-term relationships, and aligning initiatives with market trends.</p>
    <p><b>Web Presence Manager</b> | AJ Management INTL (Remote)</p>
    <p>Managing the digital presence of renowned singer Ahmed Jahanzeb, including website development, social media strategy, and online branding.</p>

    <p><b>Junior Web Developer</b> | DiscoveriTech, Houston, TX</p>
    <p>Developing front-end web applications, optimizing page loading times, and building reusable code for scalable projects.</p>

    <div className="spacer"></div>
    <h4>Education:</h4>
    <p><b>BSc Computer Science (Hons.)</b> | Multimedia University, Malaysia (Oct 2017 - Nov 2021)</p>
    <p><b>MSc Interactive Multimedia</b> | University of Westminster, UK (Feb 2022 - Nov 2023)</p>

    <div className="spacer"></div>
    <h4>Honors & Awards:</h4>
    <p><b>Top 1% Google CodeJam'21</b> (Google)</p>
    <p><b>Runner-Up Speed Debugging ProCom'19</b> (Multimedia University, Cyberjaya Campus, Malaysia)</p>
    <p><b>Winner ACM Freshmen Cup'17</b> (Multimedia University, Cyberjaya Campus, Malaysia)</p>
    <p><b>Dean's Honor List</b> (Fall 2018)</p>

    <div className="spacer"></div>
    <h4>Certifications:</h4>
    <p><b>Meta Social Media Marketing Professional Certificate</b> (Coursera, Mar 2021)</p>
    <p><b>Google Digital Marketing & E-commerce Professional Certificate</b> (Google, Mar 2020)</p>
    <p><b>Data Structures and Algorithms Supreme Batch</b> (CodeHelp, Mar 2019)</p>
    <p><b>Web Developer Bootcamp</b> (Udemy, Jul 2018)</p>
</div>
